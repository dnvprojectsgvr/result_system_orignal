...
function cou()
{
	...
	{	
		...
		document.getElementById('cos').style.borderColor="#FF0000";
		return false;
	}
	else
	{
		document.getElementById('coerr').innerHTML="";
		document.getElementById('cos').style.borderColor="#008000";
		return true;
	}	
}
function yer()
{
	...
	{	
		...
		document.getElementById('yea').style.borderColor="#FF0000";
		return false;
	}
	else
	{
		document.getElementById('yeerr').innerHTML="";
		document.getElementById('yea').style.borderColor="#008000";
		return true;
	}
}
function rollr()
{
	...
	else if(ro.value==00 || ro.value==0)
	{
		document.getElementById('rollerr').innerHTML="Invalid Roll No";
		document.getElementById('roll').style.borderColor="#FF0000";
		return false;
	}
	...
	else
	{
		...
		document.getElementById('roll').style.borderColor="#008000";
		return false;
	}
}
...
function mob()
{
	...
	if(m.value=="")
	{
		...
		document.getElementById('usi').style.borderColor="#FF0000";
		return false;
	}
	...
	else if(m.value.match(numbers))
	{
		...
		document.getElementById('usi').style.borderColor="#008000";
		return true;
	}
	else
	{
...
function genusi()
{
	...
	if(ro.value==00 || ro.value==0)
	{
		document.getElementById('userid').value="";
		document.getElementById('userid').style.borderColor="#FF0000";
		return false;
	}
	else if(document.getElementById('userid').value.length<9)
	{
		document.getElementById('userid').value="";
		document.getElementById('userid').style.borderColor="#FF0000";
	}
	else
	{
		...
		document.getElementById('cos').value + 
		document.getElementById('roll').value;
		document.getElementById('userid').style.borderColor="#008000";
	}
/*
	var ro=document.p.roll;
	var y=document.p.ye;
	...
	else if(ro.value==00 && y.value==0)
	{
		document.getElementById('userid').style.borderColor="#FF0000";
		return false;
	}
	else if(ro.value==00 && c.value==0)
	{
		document.getElementById('userid').style.borderColor="#FF0000";
		return false;
	}
	else if(ro.value==00 && c.value==0 && y.value==0)
	{
		document.getElementById('userid').style.borderColor="#FF0000";
		return false;
	}
